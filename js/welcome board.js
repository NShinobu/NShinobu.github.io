    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            function showWelcome() {
                ...
                let dist = getDistance(121.50476, 31.41144, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
                ...
                document.getElementsByClassName("announcement_content")[0].innerHTML =
                    `欢迎来自<span><span style=<span style="color:rgb(57, 197, 187)">${pos}</span>的小伙伴，${timeChange}<br>
        你距离布束砥信゜约有<span><span style=<span style="color:rgb(57, 197, 187)">${dist}</span>公里。<br>${posdesc}
        `;
            }
            showWelcome()
        }
